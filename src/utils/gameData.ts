...
export const INITIAL_MAIN_QUESTS: DailyQuest[] = [
  {
...
export const INITIAL_DAILY_QUESTS: DailyQuest[] = [
  { id: 'daily_harvest', category: 'daily', title: 'Nông Dân Cần Cù: Gặt 8 hoa màu', type: 'harvest', progress: 0, target: 8, rewardXu: 800, rewardExp: 80, completed: false, claimed: false, icon: '🌾' },
  { id: 'daily_fish', category: 'daily', title: 'Cần Thủ Ven Hồ: Câu 4 con cá', type: 'fish', progress: 0, target: 4, rewardXu: 900, rewardExp: 90, completed: false, claimed: false, icon: '🐟' },
  { id: 'daily_feed', category: 'daily', title: 'Chăm Sóc Chuồng Trại: Cho ăn 2 lần', type: 'feed_animal', progress: 0, target: 2, rewardXu: 600, rewardExp: 60, completed: false, claimed: false, icon: '🐔' },
  { id: 'daily_park', category: 'daily', title: 'Dạo Mát Công Viên: Ném xu hoặc chat', type: 'park_interact', progress: 0, target: 1, rewardXu: 500, rewardExp: 50, completed: false, claimed: false, icon: '⛲' },
  { id: 'daily_baucua', category: 'daily', title: 'Thử Vận May: Cược 2 ván Bầu Cua', type: 'baucua_play', progress: 0, target: 2, rewardXu: 700, rewardLuong: 1, rewardExp: 70, completed: false, claimed: false, icon: '🎲' },
];

export const INITIAL_ALL_QUESTS: DailyQuest[] = [...INITIAL_MAIN_QUESTS, ...INITIAL_DAILY_QUESTS];
